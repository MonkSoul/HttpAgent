...
public class HttpRemoteServiceTests(ITestOutputHelper output)
{
    ...
    public void CreateHttpClientWithDefaults_ReturnOK()
    {
        ...
        Assert.Equal("HttpAgent/1.0.5.2", httpClient.DefaultRequestHeaders.GetValues("User-Agent").First());
        ...
        Assert.Equal("HttpAgent/1.0.5.2", httpClient2.DefaultRequestHeaders.GetValues("User-Agent").First());
        ...
        Assert.Equal("HttpAgent/1.0.5.2", httpClient4.DefaultRequestHeaders.GetValues("User-Agent").First());
