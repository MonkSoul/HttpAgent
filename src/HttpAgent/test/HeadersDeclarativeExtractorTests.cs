...
public class HeadersDeclarativeExtractorTests
{
    [Fact]
    public void New_ReturnOK()
    {
        Assert.True(typeof(IHttpDeclarativeExtractor).IsAssignableFrom(typeof(HeadersDeclarativeExtractor)));

        var extractor = new HeadersDeclarativeExtractor();
    ...
    public void Extract_ReturnOK()
    {
        ...
        new HeadersDeclarativeExtractor().Extract(httpRequestBuilder1, context1);
        ...
        Assert.Equal("header4", httpRequestBuilder1.HeadersToRemove.First());
        Assert.Equal("header3", httpRequestBuilder1.HeadersToRemove.Last());
        ...
        new HeadersDeclarativeExtractor().Extract(httpRequestBuilder2, context2);
        ...
        new HeadersDeclarativeExtractor().Extract(httpRequestBuilder3, context3);
        ...
        Assert.Equal(["value21", "value2"], httpRequestBuilder3.Headers["header2"]);
        ...
        new HeadersDeclarativeExtractor().Extract(httpRequestBuilder4, context4);
        ...
        new HeadersDeclarativeExtractor().Extract(httpRequestBuilder5, context5);
...
public interface IHeadersDeclarativeTest : IHttpDeclarativeExtractor
{
    ...
    [Post("http://localhost:5000")]
    [Headers("header2", "value21")]
    [Headers("header4", "value4")]
    Task Test3();

    [Post("http://localhost:5000")]
    [Headers("header3", "value3")]
    Task Test4([Headers] int id, [Headers] [Headers(AliasAs = "myName")] string name, [Headers(Values = 30)] int? age);
}